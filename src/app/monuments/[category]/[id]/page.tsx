...
const ProductPage = () => {
  ...
  const [imageSlideType, setImageSlideType] = useState<"work" | "example">(
    "work"
  ); // Определяет, какие изображения отображаются
            ...
            <div className="flex flex-col w-5/12">
              <div className="bg-[#f5f6fa] p-5 rounded-lg mb-5">
                  ...
                  <div className="mb-5">
                    ...
                    <div className="flex flex-wrap mt-3 gap-2">
                      ...
                      <button
                        ...
                        className={`w-1/4 aspect-square rounded-lg border-2 transition ${
                          selectedColor === null
                ...
                <div className="space-y-2.5 mb-5">
                  <button
                    className="w-full py-3 bg-[#2c3a54] text-white rounded-lg font-bold hover:bg-[#1a273b] transition"
                    onClick={openModal}
                  >
                    Заказать
                  </button>
          ...
          <div className="border-b border-gray-200 mb-5">
            <div className="flex space-x-6">
              <button
                ...
                className={`pb-2 font-bold text-[16px] ${
                  activeTab === "characteristics"
                    ? "border-b-2 border-[#2c3a54] text-[#2c3a54]"
                    : "text-[#6B809E] hover:text-[#2c3a54]"
                }`}
              >
                Характеристики
              </button>
