            ...
            <section className="page-centered mt-5 max-w-[1300px] flex">
                ...
                <div className="w-[100%] lg:ml-5 lg:max-w-[75%]">
                    ...
                    <div className="mt-7.5 font-[600] shadow-md p-7.5">
                        ...
                        <h2 className="text-[24px] font-bold text-[#2D4266] mb-3.75">Преимущества памятников из гранита</h2>
                        <p className=" text-[#2D4266] mb-5">Памятники из гранита отличаются следующими плюсами:</p>
                        ...
                        <h2 className="text-[24px] font-bold text-[#2D4266] mb-3.75">Как выбрать памятник из гранита?</h2>
                        <p className=" text-[#2D4266] mb-5">Выбор памятника из гранита — это важный и ответственный шаг. Советы ниже помогут сделать правильный выбор.</p>
                        ...
                        <h2 className="text-[24px] font-bold text-[#2D4266] mb-3.75">Виды изготавливаемых памятников</h2>
                        <p className=" text-[#2D4266] mb-5">Существует несколько классификаций памятников. По количеству усопших памятники бывают:</p>
                        <ul className="list-disc pl-5  text-[#2D4266] space-y-1 mb-5">
                            <li>одиночными;</li>
                            <li>двойными;</li>
                            <li>семейными (для трёх и более человек).</li>
                        </ul>
                        <p className=" text-[#2D4266] mb-2.5">По внешнему виду и форме памятники делят на:</p>
                        <ul className="list-disc pl-5  text-[#2D4266] space-y-1 mb-5">
                        ...
                        <h2 className="text-[24px] font-bold text-[#2D4266] mb-3.75">Цены на памятники из гранита в Минске</h2>
                        <p className=" text-[#2D4266] mb-5">Цена на памятники в Минске зависит от многих факторов.</p>
                        <p className=" text-[#2D4266] mb-2.5">
                        ...
                        <h2 className="text-[24px] font-bold text-[#2D4266] mb-3.75">Преимущества создания памятников в «Центр Гранит»</h2>
                        <p className=" text-[#2D4266] mb-5">Мы предлагаем гранитные памятники на понятных, выгодных и простых условиях. Наши преимущества:</p>
                        <ol className="list-decimal pl-5  text-[#2D4266] space-y-1">
                        ...
                        <p className=" text-[#2D4266] mt-5">Чтобы купить памятник в Минске, достаточно позвонить нам или оставить заявку на сайте. Мы поможем с выбором, организуем доставку и монтаж.</p>
                    </div>
