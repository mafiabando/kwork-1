    ...
    const campaigns = [
        {
            ...
            image: isMobile ? "/blog/1m.webp" : "/blog/1.webp",
            date: "30.10.2023",
            link: "/",
        },
        {
            ...
            image: isMobile ? "/blog/2m.webp" : "/blog/2.webp",
            date: "30.10.2023",
            link: "/",
        },
        {
            ...
            description: "При заказе памятника и благоустройства до 25 декабря 2023 года",
            image: isMobile ? "/blog/3m.webp" : "/blog/3.webp",
            date: "30.10.2023",
            link: "/",
        },
        {
            ...
            image: isMobile ? "/blog/4m.webp" : "/blog/4.webp",
            date: "30.10.2023",
            link: "/",
        },
    ];
    ...
    return (
        <section className="bg-[#f5f6fa] mt-17 md:mt-30">
            <div className="max-w-[1300px] pt-[93px] container-centered">
                ...
                <h2 className="text-4xl font-bold text-[#2c3a54] ml-2.5 mb-7.5">Блог</h2>
                        ...
                        >
                            <a href={campaign.link} className="flex md:block">
                                ...
                                <div className="w-[48%] justify-between flex flex-col md:block bg-[#f5f6fa] md:bg-white md:w-full px-2 py-0 md:px-6 md:py-5 md:p-6">
                                    <h3 className="font-bold text-sm md:text-[16px] text-[#2c3a54] md:mb-1.25">{campaign.title}</h3>
                                    <p className="hidden md:block text-[16px] text-[#2c3a54cc] leading-relaxed">
                                        {campaign.description}
                                    </p>
                                    <span className="text-sm md:hidden text-[#2c3a54cc] leading-relaxed">{campaign.date}</span>
                                </div>
                            </a>
                        </div>
                    ))}
