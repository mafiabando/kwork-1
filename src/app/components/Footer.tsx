...
const Footer = () => {
    // Теперь openMenus — массив, чтобы можно было открывать несколько меню
        ...
        <footer className="bg-white border-t border-[#e6e8ed]">
            ...
            <div className="col-span-12 mx-1 lg:hidden mb-6">
                {[
                    ...
                    { title: "Другие товары", key: "accessories", items: footerMenu.accessories },
                    ...
                    <div key={category.key} className="border-b border-[#e6e8ed]">
                        <button
                            ...
                            className={`w-full flex justify-between items-center py-3.75 pr-4 text-left transition-colors ${openMenus.includes(category.key)
                        ...
                        >
                            ...
                            <Image
                                ...
                                width={12}
                                height={8}
                                className={`transform transition-transform ${openMenus.includes(category.key) ? "rotate-180" : ""
                                    }`}
                            />
                        </button>
            ...
            {/* Верхняя строка */}
            <div className="max-w-[1300px] container-centered pb-6.25 md:pb-7.5 grid grid-cols-1 lg:grid-cols-12">
                ...
                <div className="col-span-4">
                    ...
                    <div className="flex mt-1 space-x-4.25">
                        <button className="bg-white border border-[#2c3a54] text-[#2c3a54] px-3.5 py-1 md:px-3.75 md:py-2.25 rounded-full font-bold hover:bg-[#2c3a54] hover:text-white transition">
                            Заказать звонок
                        </button>
                    ...
                    <Link href="#" className="text-sm text-[#2c3a54] mt-1 hover:underline">Подробнее</Link>
                </div>
                ...
                <div className="col-span-2 hidden lg:block px-2.5">
                    ...
                    <ul className="space-y-2">
                        {footerMenu.monuments.map((item, index) => (
                            <li key={index}>
                                <Link href={item.href} className="text-sm text-[#2c3a54] hover:underline hover:text-[#2c3a54cc] transition">
                                    {item.name}
                                </Link>
                            </li>
                        ))}
                ...
                <div className="col-span-2 hidden lg:block px-2.5">
                    <h3 className="font-bold text-lg text-[#2c3a54] mb-4">Другие товары</h3>
                    <ul className="space-y-2">
                ...
                <div className="max-w-[1300px] container-centered flex flex-col md:flex-row justify-between items-start md:items-center">
                    <div className="text-xs text-[#969ead] leading-relaxed lg:max-w-2/3">
                        <span className="block max-w-[788px]">
                            Данный интернет-сайт носит информационный характер. Каждый заказ носит индивидуальный характер. Эскиз товара, размер, варианты оформления, окончательная стоимость оговариваются во время личной консультации в офисе компании перед заключением договора.
                            <br />
