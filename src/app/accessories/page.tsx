...
const getProductsForPage = (cards: typeof productsAccessories, page: number, productsPerPage: number) => {
...
const AccessoriesPage = () => {
    ...
    const currentProducts = getProductsForPage(productsAccessories, currentPage, productsPerPage);

    // Рассчитываем общее количество страниц
    const totalPages = getTotalPages(productsAccessories.length, productsPerPage);
            ...
            <section className="page-centered mt-5 max-w-[1300px] flex">
                ...
                <div className="w-[100%] lg:ml-5 lg:max-w-[75%]">
                    ...
                    <div hidden={isTablet} className="flex justify-end mb-5">
                        ...
                        <button
                            onClick={() => handleProductsPerPageChange(productsAccessories.length)}
                            className={`px-2 py-1 mx-1 text-[14px] font-medium rounded text-[#2c3a54] ${productsPerPage === productsAccessories.length
                                ? ""
                                : "cursor-pointer underline underline-offset-3 hover:no-underline"
                                }`}
                        >
