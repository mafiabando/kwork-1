...
export const productsFences: Product[] = [
  {
    id: 1,
    name: "Гранитная ограда ГО-1",
    textPrice: 'от 785 руб.',
  ...
  {
    id: 2,
    name: "Гранитная ограда ГО-2",
    textPrice: 'от 515 руб.',
    category: "Гранитные ограды",
    image: "/fences/2.webp",
    colors: [
      {
