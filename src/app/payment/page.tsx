            ...
            <section className="page-centered mt-5 max-w-[1300px] flex">
                ...
                <div className="w-[100%] lg:ml-5 lg:max-w-[75%]">
                    ...
                    <div className='p-5 lg:p-7.5 shadow-sm font-[600]'>
                        ...
                        <div className="mb-7.5">
                            <h2 className="font-bold text-[#2c3a54] mb-5">Рассрочка ЦентрГранит</h2>
                        ...
                        <div className="mb-7.5">
                            <h2 className=" font-bold text-[#2c3a54] mb-3.75">Условия оплаты при покупке через ЦентрГранит.бай:</h2>
                            <ul className="list-disc pl-5 text-[#2c3a54] space-y-1">
